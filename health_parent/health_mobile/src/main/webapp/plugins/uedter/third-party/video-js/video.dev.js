 ...
 * have this extra overhead unnecessarily, on controller devices where extra
 ...
 * This includes most controller devices (iOS, Android) and older versions of
 * Safari.
 *
 * @return {vjs.Player} self
 */
 ...
 * on a controller device a click on the video toggles controls.
...
vjs.Html5 = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // Our goal should be to get the custom controls on controller solid everywhere
